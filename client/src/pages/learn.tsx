...
export default function Learn() {
        ...
        const fetchUserCoupons = async () => {
            ...
            try {
                const res = await fetch(
                    `http://192.168.1.43:3000/api/v1/coupons/my-coupons`,
                    {
                        headers: {
    ...
    const createCoupon = async () => {
        ...
        try {
            setCouponError(null);
            const res = await fetch(`http://192.168.1.43:3000/api/v1/coupons`, {
                method: "POST",
                headers: {
    ...
    useEffect(() => {
        const fetchPackages = async () => {
            try {
                const res = await fetch(`http://192.168.1.43:3000/api/v1/packages`);
                const json = await res.json();
